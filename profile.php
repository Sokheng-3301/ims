...
<body>
    ...
    <section id="sidebar__content" onclick="closeProfileDash(), topNotication()">
        ...
        <div id="main__content">
            <div class="top__content_title">
                <h5 class="super__title">My profile <span><?=systemname?></span></h5>
                <p><i class="fa fa-tachometer" aria-hidden="true"></i><a href="<?=SITEURL?>dashboard.php">Home</a> > Profile</p>
           </div>
        <?php
        $teacher = mysqli_query($conn, "SELECT * FROM teacher_info WHERE teacher_id='". $_SESSION['LOGIN_USERID'] ."'");
        ...
        ?>
           <div class="all__teacher view__teacher p-3">
                ...
                <div class="title">
                    <h3 class="text-center fw-bold mt-4">ព័ត៌មានលម្អិត និងប្រវត្តិរូបរបស់អ្នក</h3>
                </div>
                <div class="title">
           ...
           <?php
            ...
            if(isset($_SESSION['LOGIN_TYPE']) == 'Super-amin'){
        ?>
            <p><i class="fa fa-user-circle-o" aria-hidden="true"></i>You are a super admin.</p>
        <?php
            }
        }
        ?>
    ...
    <div id="popUp">
        <div class="form__verify border-success text-center">
            ...
            <p class="mt-4">
                <a href="<?=SITEURL;?>profile.php" class="ok btn btn-sm btn-secondary px-5">Ok</a>
            </p>
        </div>
    </div>
    <?php
