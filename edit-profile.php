...
#============================= UPDATE TEACHER INFO HERE ===========================#
        $teacher = mysqli_query($conn, "SELECT * FROM teacher_info WHERE teacher_id = '". $_SESSION['TEACHER_ID'] ."'");
    ...
    ?>
        <div id="main__content">
           ...
           <div class="top__content_title">
                <h5 class="super__title">Edit profile<span><?=systemname?></span></h5>
                <p><i class="fa fa-tachometer" aria-hidden="true"></i><a href="<?=SITEURL?>dashboard.php">Home</a> > Edit profile</p>
           </div>
           
           <div class="add__member update__profile">                    
                <form action="<?=SITEURL;?>profile-action.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="teacher_id" value="<?=$teacher_id;?>">

                    <input type="hidden" name="old_profile" value="<?=$teacher_data['profile_image'];?>">

                    <label for="profile__account" class="label__profile">
                        <div class="img__profile" id="preview__profile">
                            <img src="<?=SITEURL?>ims-assets/ims-images/<?php
                                if($teacher_data['profile_image'] == ''){
                                    echo 'user.png';
                                }else{
                                    echo $teacher_data['profile_image'];
                                }
                            ?>" id="img_profile" alt="">
                            <div class="camera">
                    ...
                    <input type="file" name="profile_account" class="d-none" id="profile__account" accept="image/png, image/jpg, image/jpeg" onchange="preview(event)">
                    <input type="hidden" name="update_id" value="<?=$teacher_id;?>">
                    ...
                    <div class="control__form__add">
                        <div class="part">
                            ...
                            <textarea name="place_birth" id="" cols="30" rows="8" placeholder="ភូមិ ឃុំ/សង្កាត់ ស្រុក/ខណ្ឌ ខេត្ត"><?=$teacher_data['place_birth'];?></textarea>
                    ...
                    <div class="button">
                        <button type="submit" name="update_profile" class="btn-update"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Update</button>
                    </div>
                </form>
           </div> 
    ...
    <script>
        function preview(evt){
            ...
            document.getElementById("preview__profile").innerHTML = img;
            // alert("Hi");
        }
    </script>
