...
<body>
    ...
    ?>
        ...
        <div id="main__content" >
           ...
           <div class="my-3">
                <a href="<?=SITEURL. 'request.php';?>" class="btn btn-sm btn-secondary px-2"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</a>
           </div>
                ...
                <?php
                    ...
                    <div class="btn__container">
                        ...
                        <div class="right">
                            ...
                            <a href="<?=SITEURL;?>preview-transcript.php?id=<?=$student_info_fetch['id'];?>" target="_blank" class="export"><i class="fa fa-upload" aria-hidden="true"></i>Export</a>
                        ...
                        <section id="main-content">
                            <div class="control-result">
                                <div class="request-content">
                                    <?php include_once('ims-student/include-result.php');?>
                                </div>
                            </div>
                        </section>
                    </div>
