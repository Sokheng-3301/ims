            ...
            <div class="all__teacher schedule">
                ...
                <form action="" method="post">
                    ...
                    <div class="filter__manage">
                            ...
                            <select name="class" id="" required>
                                ...
                                ?>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['class']) == $result['class_id']){
                                          echo "selected";
                                        }    
                        ...
                        <button name="filter_schedule" type="submit"><i class="fa fa-search" aria-hidden="true"></i></button>            
                    </div>
                </form>
                ...
                <!-- start schedule  -->
                    ...
                    ?>
                        ...
                        <div class="schedule__container mb-3">
                            <div id="schedule_top">
                                <div class="part border_info">
                                    <p class="fw-bold mb-2"><i class="fa fa-info-circle" aria-hidden="true"></i>Class information</p>
                                    <div class="grid">
                                        <?php
                                            $class_info = mysqli_query($conn, "SELECT * FROM class 
                                                                                WHERE class_id = '". $class ."'");
                                            if(mysqli_num_rows($class_info) > 0){
                                                $class_fetch = mysqli_fetch_assoc($class_info);
                                        ?>
                            ...
                            <!-- MONDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃចន្ទពេលព្រឹកពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- MONDAY END  -->
                            ...
                            <!-- TUESDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃអង្គារពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- TUESDAY END  -->
                            ...
                            <!-- WEDNESDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃពុធពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- WEDNESDAY END  -->
                            ...
                            <!-- THURSDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃព្រហស្បតិ៍ពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- THURSDAY END  -->
                            ...
                            <!-- FRIDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃសុក្រពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- FRIDAY END  -->
                            ...
                            <!-- SATURDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃសៅរ៍រពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- SATURDAY END  -->
                            ...
                            <!-- SUNDAY START  -->
                                <div class="content">
                                    ...
                                    <?php
                                            ...
                                            echo '<p class = "mt-3">កាលវិភាគថ្ងៃអាទិត្យពុំទាន់បានកំណត់នៅឡើយទេ។</p>';
                                        }
                                    ?>                                         
                                </div>
                            <!-- SUNDAY END  -->
    ...
    <div class="modal-dialog modal-dialog-centere d">
        <div class="modal-content">
            ...
            <form action="<?=SITEURL;?>schedule-action.php" method="post">
                <input type="hidden" name="q" value="<?=$_GET['q'];?>" required>
