                    ...
                    <div id="border__form">
                        ...
                        <form action="<?=SITEURL;?>schedule-action.php" method="post">
                            ...
                            <div class="manage__form">
                                ...
                                <div class="part">   
                                    <label for="day">5. Day <span class="text-danger">*</span></label>
                                    ...
                                    <div class="d-flex start_end_time" style="margin-top: 20px;">
                                        <div class="block">
                                            <label for="start_time">6. Start time <span class="text-danger">*</span></label>
                                            <input type="time" id="start_time" name="start_time" oninput="checkTime()" required>
                                        </div>
                                        <div class="block">
                                            <label for="end_time">7. End time <span class="text-danger">*</span></label>
                                    ...
                                    <label for="day" class="mt-2">8. Instructor <span class="text-danger">*</span></label>
                    ...
                    <form action="<?=SITEURL;?>schedule-action.php" method="post">
                        <div class="manage__form">
                            <div class="part">     
                                ...
                                <label for="day" class="mt-2">3. Day <span class="text-danger">*</span></label>
                                <select name="day" id="day" data-live-search="true"  class="selectpicker d-block w-100 mb-3 mt-1" required>
                                    <option disabled selected>Please select day</option>
                                <?php
                                    $day_in_week = array('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday');
                            ...
                            <div class="part">   
                                ...
                                <div class="d-flex start_end_time" style="margin-top: 5px;">
                                    <div class="block">
                                        <label for="start_time">4. Start time <span class="text-danger">*</span></label>
                                        <input type="time" id="start_time" name="start_time" oninput="checkTime()" required value="<?=$schedule_result['start_time'];?>">
                                    </div>
                                    <div class="block">
                                        <label for="end_time">5. End time <span class="text-danger">*</span></label>
                                ...
                                <label for="day" style="margin-top: 2px;">6. Instructor <span class="text-danger">*</span></label>
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                        <option <?php echo ($schedule_result['room'] == $result['id']) ? 'selected': '';?>  value="<?=$result['room'];?>"><?=$i++. ". ".$result['room'];?></option>
                                <?php
                                    }
                                ?>                             
                                </select>  
